...
<Preview client:load>
  <Text variant="default">Default paragraph text.</Text>
  <Text variant="muted">Muted supporting text.</Text>
  <Text variant="brand" weight="semibold">Brand accent text.</Text>
</Preview>

> **[View in Storybook →](https://florextech.github.io/florex-ui/?path=/story/components-text)** — Interactive preview with controls
